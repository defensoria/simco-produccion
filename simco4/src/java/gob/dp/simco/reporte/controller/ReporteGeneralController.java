...
//        totalGeneraCasosAccionesProtesta = reporteEjecutivoService.totalGeneralCasosAccionesProtesta(filtroReporte);
        ...
        ejecutivo.setPorcentajeTotalCasosActivos(cambiarPorcentaje(totalCasosRegistrados, totalCasosActivos, "DEL TOTAL DE CASOS"));
        ejecutivo.setPorcentajeTotalCasosLatentes(cambiarPorcentaje(totalCasosRegistrados, totalCasosLatentes, "DEL TOTAL DE CASOS"));
        ...
        ejecutivo.setPorcentajeCasosFaseDialogo("conflictos en proceso de diálogo ("+cambiarPorcentaje(totalCasosActivos,totalCasosFaseDialogo)+" de los casos activos)");
        ejecutivo.setPorcentajeCasosFaseDialogoNegociacion("mediante mesas de diálogo ("+cambiarPorcentaje(totalCasosFaseDialogo,totalCasosDialogoNegociacion)+")"+cambiarPorcentaje(totalCasosFaseDialogo,totalCasosDialogoNegociacion));
        ejecutivo.setPorcentajeCasosFaseDialogoReuniones("casos se encuentran en reuniones preparatorias para el diálogo ("+cambiarPorcentaje(totalCasosFaseDialogo,totalCasosDialogoReuniones)+")");
        ejecutivo.setPorcentajeCasosFaseDialogoEspacionDialogo("casos cuentan con presencia de la DP en los espacios de diálogo ("+cambiarPorcentaje(totalCasosFaseDialogo,totalCasosDialogoEspacioDialogo)+")");
        ...
        ejecutivo.setPorcentajeCasosACVictimaViolencia("casos presentaron al menos un hecho de violencia desde que iniciaron ("+cambiarPorcentaje(totalCasosActivos,totalCasosACVictimaViolencia)+")");
        ejecutivo.setPorcentajeCasosACVictimaViolenciaMes("casos presentaron al menos un hecho de violencia en el mes("+cambiarPorcentaje(totalCasosActivos,totalCasosACVictimaViolenciaMes)+")");
