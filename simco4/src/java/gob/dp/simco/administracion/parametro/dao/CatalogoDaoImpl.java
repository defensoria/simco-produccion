...
public class CatalogoDaoImpl extends SqlSessionDaoSupport implements CatalogoDao
{
    ...
    public Catalogo viewCatalogoPadre(Catalogo catalogo){
       return getSqlSession().selectOne("gob.dp.simco.administracion.parametro.dao.CatalogoDao.viewCatalogoPadre",catalogo);
    }

    @Override
    public Catalogo viewCatalogoHijo(Catalogo catalogo){
        return getSqlSession().selectOne("gob.dp.simco.administracion.parametro.dao.CatalogoDao.viewCatalogoHijo",catalogo);
    }

    @Override
    public void nuevoCatalogoPadre(Catalogo catalogo){
       getSqlSession().insert("gob.dp.simco.administracion.parametro.dao.CatalogoDao.nuevoCatalogoPadre",catalogo);
    }

    @Override
    public void nuevoCatalogoHijo(Catalogo catalogo){
       getSqlSession().insert("gob.dp.simco.administracion.parametro.dao.CatalogoDao.nuevoCatalogoHijo",catalogo);
    }

    @Override
    public void updateCatalogoPadre(Catalogo catalogo){
       getSqlSession().update("gob.dp.simco.administracion.parametro.dao.CatalogoDao.updateCatalogoPadre",catalogo);
    }

    @Override
    public void updateCatalogoHijo(Catalogo catalogo){
       getSqlSession().update("gob.dp.simco.administracion.parametro.dao.CatalogoDao.updateCatalogoHijo",catalogo);
    }

    @Override
    public void updateEstadoCatalogoHijo(Catalogo catalogo) {
        getSqlSession().update("gob.dp.simco.administracion.parametro.dao.CatalogoDao.updateEstadoCatalogoHijo",catalogo);
    }

    @Override
    public List<Catalogo> listarCatalogoPadre() {
        return getSqlSession().selectList("gob.dp.simco.administracion.parametro.dao.CatalogoDao.listarCatalogoPadre",null);
    }

    @Override
    public Integer generarCodigoCatalogoPadre() {
        return getSqlSession().selectOne("gob.dp.simco.administracion.parametro.dao.CatalogoDao.generarCodigoCatalogoPadre");
    }

    @Override
    public Integer generarCodigoCatalogoHijo() {
        return getSqlSession().selectOne("gob.dp.simco.administracion.parametro.dao.CatalogoDao.generarCodigoCatalogoHijo");
    }

    @Override
    public List<Catalogo> parametroPorPadre(long idPadre) {
        return getSqlSession().selectList("gob.dp.simco.administracion.parametro.dao.CatalogoDao.parametroPorPadre",idPadre);
    }
}